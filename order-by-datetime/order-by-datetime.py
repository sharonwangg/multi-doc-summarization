...
summaryfile          = open('../compress/out/summaries/filtered_mask.txt', 'r', encoding='utf8')
dates_timesfile      = open('../compress/out/datetimes/filtered_mask_datetimes.txt', 'r', encoding='utf8')
organizedsummaryfile = open('out/ordered_mask.txt', 'w', encoding='utf8')
