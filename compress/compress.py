...
dates_file      = open('../initial-extraction/out/dates/symptom_extracted_dates.txt', 'r', encoding='utf8')
newsummary_file = open('out/summaries/filtered_symptom.txt', 'w', encoding='utf8')
newdates_file   = open('out/dates/filtered_symptom_dates.txt', 'w', encoding='utf8')
